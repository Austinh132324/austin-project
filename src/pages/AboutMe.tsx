...
const experiences = [
  ...
  },
  {
    ...
    bullets: [
      'Mentored 3 interns and conducted thorough code reviews to maintain high code quality standards.',
      'Converted CI/CD pipelines to YAML in Azure DevOps, enabling on-demand deployments instead of weekly-only release windows.',
      ...
      'Led the migration of legacy Angular applications to modern React, improving development time by 25% and load times by 15%.',
      'Owned an end-to-end Kafka messaging feature integrated with Elasticsearch for real-time, event-driven data workflows.',
