const kb: Record<string, string> = {
  ...
  jbhunt: "At JB Hunt, I lead modernization and ongoing support of 4 enterprise production applications. I architect Java Spring Boot microservices replacing legacy mainframe dependencies, and I'm driving an enterprise migration from DB2 mainframe to Google BigQuery — re-creating COBOL modules as scalable cloud services. I design distributed systems with Kafka messaging, Elastic indexing, and containerized deployments, and own full lifecycle delivery across Angular/React frontends, backend services, CI/CD pipelines, and production support. I also converted Azure DevOps pipelines to YAML, implemented Cypress testing in build gates, modernized the monorepo with Module Federation, and led the Angular-to-React migration that improved dev velocity by 25% and reduced page load time by 15%.",
